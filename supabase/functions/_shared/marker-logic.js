...
// loader).
//
// Imports the VENDORED copy (./mcp-provisioning/, sibling dir, generated by
// scripts/vendor-shared-packages.mjs -- run automatically before `npm
// test` via package.json's "pretest"), not the bare `@mp4marketing/mcp-
// provisioning` specifier this file used originally. Deno's bundler can't
// resolve a bare specifier at all (confirmed live 2026-09-20: "Relative
// import path ... not prefixed with / or ./ or ../"), and a plain `npm:`
// prefix would hit the same private-registry deploy bug index.ts's own
// imports were already fixed for -- see that file's header comment.
import { resolveTenantScope, markerRolesFor } from './mcp-provisioning/index.js';
